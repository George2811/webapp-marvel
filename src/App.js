    ...
    "results": [
      {
        ...
        "urls": [
          {
            "type": "detail",
            "url": "http://marvel.com/characters/76/a-bomb?utm_campaign=apiRef&utm_source=7731c14827d6b11928ab689603159fa5"
          },
          {
            "type": "comiclink",
            "url": "http://marvel.com/comics/characters/1017100/a-bomb_has?utm_campaign=apiRef&utm_source=7731c14827d6b11928ab689603159fa5"
          }
        ]
      }
    ]
    ...
    <div>
      <Router>
        ...
        <Routes>
          ...
          <Route path="/superheroes/1" element={<SuperHeroeDetailsPage data={data} />} />
        </Routes>
        <Footer />
      </Router>     
    </div>
